...
public class Ex28_2_TicketSystem {
	private static final int QUEUE_CAPACITY = 10; // 큐 크기 10
	private static final int NUM_PEOCESSORS = 3; // 프로세스 3개
	
	public static void main(String[] args) {
		BlockingQueue<Ticket> ticketQueue = new ArrayBlockingQueue<>(QUEUE_CAPACITY);
		
		ExecutorService executor = Executors.newFixedThreadPool(NUM_PEOCESSORS);
		
		for(int i=0; i<NUM_PEOCESSORS; i++) {
...
class Ticket {
	...
	public Ticket(int id, String descripeion) {
		this.id = id;
